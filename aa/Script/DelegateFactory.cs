...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(System.Action<UnityEditor.PackageManager.PackageRegistrationEventArgs>), factory.System_Action_UnityEditor_PackageManager_PackageRegistrationEventArgs);
		...
		DelegateTraits<System.Action<UnityEditor.PackageManager.PackageRegistrationEventArgs>>.Init(factory.System_Action_UnityEditor_PackageManager_PackageRegistrationEventArgs);
		...
		TypeTraits<System.Action<UnityEditor.PackageManager.PackageRegistrationEventArgs>>.Init(factory.Check_System_Action_UnityEditor_PackageManager_PackageRegistrationEventArgs);
		...
		StackTraits<System.Action<UnityEditor.PackageManager.PackageRegistrationEventArgs>>.Push = factory.Push_System_Action_UnityEditor_PackageManager_PackageRegistrationEventArgs;
	...
	class System_Action_UnityEditor_PackageManager_PackageRegistrationEventArgs_Event : LuaDelegate
	{
		public System_Action_UnityEditor_PackageManager_PackageRegistrationEventArgs_Event(LuaFunction func) : base(func) { }
		public System_Action_UnityEditor_PackageManager_PackageRegistrationEventArgs_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(UnityEditor.PackageManager.PackageRegistrationEventArgs param0)
		{
			func.BeginPCall();
		...
		public void CallWithSelf(UnityEditor.PackageManager.PackageRegistrationEventArgs param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public System.Action<UnityEditor.PackageManager.PackageRegistrationEventArgs> System_Action_UnityEditor_PackageManager_PackageRegistrationEventArgs(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<UnityEditor.PackageManager.PackageRegistrationEventArgs> fn = delegate(UnityEditor.PackageManager.PackageRegistrationEventArgs param0) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_UnityEditor_PackageManager_PackageRegistrationEventArgs_Event target = new System_Action_UnityEditor_PackageManager_PackageRegistrationEventArgs_Event(func);
			System.Action<UnityEditor.PackageManager.PackageRegistrationEventArgs> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_UnityEditor_PackageManager_PackageRegistrationEventArgs_Event target = new System_Action_UnityEditor_PackageManager_PackageRegistrationEventArgs_Event(func, self);
			System.Action<UnityEditor.PackageManager.PackageRegistrationEventArgs> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_UnityEditor_PackageManager_PackageRegistrationEventArgs(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<UnityEditor.PackageManager.PackageRegistrationEventArgs>), L, pos);
	}

	void Push_System_Action_UnityEditor_PackageManager_PackageRegistrationEventArgs(IntPtr L, System.Action<UnityEditor.PackageManager.PackageRegistrationEventArgs> o)
	{
		ToLua.Push(L, o);
	}
